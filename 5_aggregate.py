...
def main(config_file):
    ...
    for agg_cfg_label in cfg['aggregate']['feature_aggregate_list']:
        ...
        print(f'Output written to {OUTPUT}', f'. Output shape: {df.shape}')

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run the aggregation pipeline.')
    parser.add_argument('pipeline_file', type=str, help='Path to the pipeline configuration file (pipeline.yml)')
